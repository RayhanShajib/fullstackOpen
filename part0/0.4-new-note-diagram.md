...
This diagram depicts the sequence of events when a user creates a new note on the traditional notes page by writing something into the text field and clicking the Save button.
...
sequenceDiagram
    ...
    activate server
    Note right of browser: User fills form and clicks Save button
    Note right of browser: Form data sent: note="My new note"
